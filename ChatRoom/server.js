...
var corsOptions = {
  origin: ["http://localhost:3000","https://basic-chat-room-hu94ibqjy-codehard04.vercel.app"],
  optionsSuccessStatus: true,
  credentials: true,
};

app.use((req, res, next) => {
  res.header("Access-Control-Allow-Origin", ["http://localhost:3000","https://basic-chat-room-hu94ibqjy-codehard04.vercel.app"]);
  res.header(
